...
print("MIDJOURNEY_KEY:", os.getenv("MIDJOURNEY_API_KEY"))
print("MONGODB_CONNECTION_STRING:", os.getenv("connection_string"))
...
print("SUBJECT:", os.getenv("subject"))
print("SENDER_PASSWORD:", os.getenv("sender_password"))
print("REMOVE_BACKGROUND_KEY:", os.getenv("remove_background_key"))
print("API_URL:", os.getenv("api_url"))
print("DEFAULT_FONT_PATH:", os.getenv("DEFAULT_FONT"))
print("FONT_SIZE:", os.getenv("FONT_SIZE"))
print("DEFAULT_LOGO_SIZE:", os.getenv("DEFAULT_LOGO_SIZE"))
print("PADDING:", os.getenv("PADDING"))
print("aws_access_key_id:", os.getenv("aws_access_key_id"))
print("aws_secret_access_key:", os.getenv("aws_secret_access_key"))
print("region:", os.getenv("region"))
print("bucket_name:", os.getenv("bucket_name"))
print("font_path:", os.getenv("font_path"))
print("text_to_add:", os.getenv("text_to_add"))
print("logo_path:", os.getenv("logo_path"))
print("prefix:", os.getenv("prefix"))
print("barbie_image_path_beach:", os.getenv("barbie_image_path_beach"))
print("barbie_image_path_gym:", os.getenv("barbie_image_path_gym"))
print("ken_image_path_beach:", os.getenv("ken_image_path_beach"))
print("ken_image_path_gym:", os.getenv("ken_image_path_gym"))
...
def generate_image():
    ...
    try:
        ...
        background_removed_image = remove_background(
            Config.REMOVE_BACKGROUND_KEY, user_image, Config.API_URL
        )

        s3_client = create_s3_connection(
            Config.aws_access_key_id, Config.aws_secret_access_key, Config.region
        )

        object_name = upload_user_image_to_s3(
            s3_client, background_removed_image, Config.bucket_name, name
        )

        presigned_url = generate_presigned_url(
            s3_client, Config.bucket_name, object_name
        )
        quadrant_image_list = []
        ...
        for character_image in [beach_image, gym_image]:
            ...
            barbie_response = create_barbie_image(
                Config.MIDJOURNEY_KEY, barbie_image_urls
            )
            ...
            for quadrant_image_number in range(1):
                result_bytes = add_text_and_logo_to_image_bytes(
                    quadrants[quadrant_image_number],
                    Config.text_to_add,
                    Config.font_path,
                    logo_bytes,
                )
                ...
                image_path = str(
                    upload_user_image_to_s3(
                        s3_client, result_bytes, Config.bucket_name, name
                    )
                )
                ...
                presigned_image_list.append(
                    generate_presigned_url(s3_client, Config.bucket_name, image_path)
                )
        ...
        result = add_data_to_collection(
            client, Config.DATABASE_NAME, Config.COLLECTION_NAME, data
        )
